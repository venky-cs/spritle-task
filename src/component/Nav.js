...
const Nav = ({sign,auth}) => {
  ...
  return (
    <div className="nav">
      <Container>
        <SideButton clicked={click} onClick={() => handleClick()}>
        ...
        <SidebarContainer>
          ...
          <SlickBar clicked={click}>
            ...
            >
              ...
              <Text  clicked={click}><Link to="/home">Home</Link></Text>
            </Item>
            <Item
              onClick={() => setClick(false)}
              activeClassName="active"
            ...
            >
              ...
              <Text clicked={click}><Link to="/createBlog">Blog</Link></Text>
            </Item>
            <Item
              onClick={() => setClick(false)}
              activeClassName="active"
            ...
            >
              ...
              <Text clicked={click}> <Link to="/save">Saved</Link></Text>
            </Item>
